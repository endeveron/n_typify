...
const MBTITypeGroups = () => {
  ...
  return (
    <div className="relative max-h-[920px] w-full base-max-w mx-auto flex flex-1 flex-col items-center justify-between">
      {/* Title */}
      <div className="min-h-32 max-h-40 flex flex-1 flex-col items-center justify-center no-select">
        {!activeGroupDescription ? (
          <AnimatedAppear
